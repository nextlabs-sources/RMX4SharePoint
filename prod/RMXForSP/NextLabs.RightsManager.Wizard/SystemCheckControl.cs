...
namespace NextLabs.RightsManager.Wizard
{
    public partial class SystemCheckControl : InstallerControl
    {
        ...
        public static bool IsSolutionDeployed()
        {
        ...
        private void TimerEventProcessor(Object myObject, EventArgs myEventArgs)
        {
            ...
            if (nextCheckIndex < checks.Count && ExecuteCheck(nextCheckIndex))
            {
                nextCheckIndex++;
                timer.Start();
                return;
        ...
        private bool ExecuteCheck(int index)
        {
            ...
            try
            {
                ...
                {
                    imageLabel.Image = global::NextLabs.RightsManager.Wizard.Properties.Resources.CheckOk;
                    textLabel.Text = check.OkText;
                }
                else if (result == SystemCheckResult.Error)
                {
                    errors++;
                    imageLabel.Image = global::NextLabs.RightsManager.Wizard.Properties.Resources.CheckFail;
                ...
                {
                    nextImageLabel.Image = global::NextLabs.RightsManager.Wizard.Properties.Resources.CheckPlay;
                }
        ...
        private void AddCheck(SystemCheck check)
        {
            ...
            imageLabel.Image = global::NextLabs.RightsManager.Wizard.Properties.Resources.CheckWait;
...
#if SP2013
            const string REGSP = @"SOFTWARE\Microsoft\Shared Tools\Web Server Extensions\15.0";
            const string REGMOSS = @"SOFTWARE\Microsoft\Office Server\15.0";
#else
            const string REGSP = @"SOFTWARE\Microsoft\Shared Tools\Web Server Extensions\16.0";
            const string REGMOSS = @"SOFTWARE\Microsoft\Office Server\16.0";
#endif 
        ...
        private class AdminServiceCheck : SystemCheck
        {
            ...
            protected override SystemCheckResult DoExecute()
            {
                try
                {
                    using (ServiceController sc = new ServiceController("SPAdminV4"))
                    {
        ...
        private class TimerServiceCheck : SystemCheck
        {
            ...
            protected override SystemCheckResult DoExecute()
            {
                try
                {
                    using (ServiceController sc = new ServiceController("SPTimerV4"))
                    {
                        if (sc.Status == ServiceControllerStatus.Running)
                        {
                            return SystemCheckResult.Success;
        ...
        private void SystemCheckControl_Load_1(object sender, EventArgs e)
        {
